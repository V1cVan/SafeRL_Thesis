    ...
    struct Utils{
        ...
        static inline void transformPoints(const Eigen::Ref<const Eigen::Matrix3Xd>& points, Eigen::Ref<Eigen::Matrix3Xd> out, const Eigen::Vector3d& C = {0,0,0}, const Eigen::Vector3d& S = {1,1,1}, const Eigen::Vector3d& A = {0,0,0}){
            Eigen::Transform t(
                ...
                Eigen::AngleAxis(A[0], Eigen::Vector3d::UnitZ()) *  // Fourth: yaw rotation
                Eigen::AngleAxis(A[1], Eigen::Vector3d::UnitY()) *  // Third: pitch rotation
                Eigen::AngleAxis(A[2], Eigen::Vector3d::UnitX()) *  // Second: roll rotation
